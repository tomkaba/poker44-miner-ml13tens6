...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            implementation_files=[
                repo_root / "weights" / "gen13_tens6_177_hardened.ts",
            ...
            defaults={
                "model_name": "poker44_ml13tens6",
                "model_version": "13.6",
                "framework": "pytorch-torchscript",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-ml13tens6",
                "repo_commit": git_commit,
                "notes": "Gen13Tens6 neural network scorer (POT=177)",
                "open_source": True,
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        synapse.predictions = [s >= 0.11 for s in scores]
